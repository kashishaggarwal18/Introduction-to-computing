...
student_data(student_id="21102018")
student_data(student_id="21102018",student_name="Kashish Aggarwal")
student_data(student_id="21102018",student_name="Kashish Aggarwal",student_class="1st Year")
print()
